            ...
            <div class="{{ $currentStep == 1 ? 'block' : 'hidden' }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" wire:model.blur="nik" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 @error('nik') border-red-300 @enderror" placeholder="Contoh: 14060xxxxxxxxx">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Nomor Kartu Keluarga <span class="text-red-500">*</span></label>
                        <input type="text" wire:model.blur="no_kk" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 @error('no_kk') border-red-300 @enderror" placeholder="Contoh: 14060xxxxxxxxx">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">NISN (10 Digit) <span class="text-red-500">*</span></label>
                        <input type="text" wire:model.blur="nisn" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 @error('nisn') border-red-300 @enderror" placeholder="Contoh: 014xxxxxxx">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Asal Sekolah Dasar/TK/PAUD</label>
                        <input type="text" wire:model.blur="previous_school" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500" placeholder="Contoh: TK Cempaka">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" wire:model.blur="full_name" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 bg-gray-50" readonly>
                    ...
                    <div>
                        ...
                        <input type="text" wire:model.blur="nickname" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500" placeholder="Contoh: Budi">
                    </div>
                    
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Jenis Kelamin <span class="text-red-500">*</span></label>
                        <select wire:model.blur="gender" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 @error('gender') border-red-300 @enderror">
                    ...
                    <div>
                        ...
                        <select wire:model.blur="religion" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 @error('religion') border-red-300 @enderror">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model.blur="birth_place" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 @error('birth_place') border-red-300 @enderror" placeholder="Contoh: Pekanbaru">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Tanggal Lahir <span class="text-red-500">*</span></label>
                        <input type="date" wire:model.blur="birth_date" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 @error('birth_date') border-red-300 @enderror">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea wire:model.blur="address" rows="3" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 @error('address') border-red-300 @enderror" placeholder="Contoh: Jl. Lintas Provinsi, Desa Kepenuhan..."></textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">RT <span class="text-red-500">*</span></label>
                        <input type="text" wire:model.blur="rt" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 @error('rt') border-red-300 @enderror" placeholder="Contoh: 001">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">RW <span class="text-red-500">*</span></label>
                        <input type="text" wire:model.blur="rw" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 @error('rw') border-red-300 @enderror" placeholder="Contoh: 002">
                    </div>
                </div>
            </div>
            ...
            <div class="{{ $currentStep == 2 ? 'block' : 'hidden' }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" wire:model.blur="mother_name" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 @error('mother_name') border-red-300 @enderror" placeholder="Sesuai Akta Kelahiran">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Nama Ayah (Opsional)</label>
                        <input type="text" wire:model.blur="father_name" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500" placeholder="Sesuai KK">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Pekerjaan Orang Tua / Wali</label>
                        <input type="text" wire:model.blur="parent_occupation" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500" placeholder="Contoh: Petani/PNS/Wiraswasta">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Nomor WhatsApp Aktif <span class="text-red-500">*</span></label>
                        <input type="text" wire:model.blur="parent_phone" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 @error('parent_phone') border-red-300 @enderror" placeholder="Contoh: 081234567890">
                    </div>
                </div>
            </div>
