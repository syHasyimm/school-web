...
<div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    <div class="flex items-center gap-3">
        ...
        <h2 class="text-xl font-bold text-gray-900 leading-tight">Buat Berita Baru</h2>
    </div>
</div>

<div class="bg-white border border-gray-200 shadow-sm rounded-2xl overflow-hidden">
    <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data" class="p-6 sm:p-8">
        @csrf
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="flex-1 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title') }}" required autofocus
                        class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-lg px-4 py-3 placeholder-gray-400" placeholder="Masukkan judul yang menarik...">
                    @error('title')
                ...
                <div>
                    ...
                    <textarea name="excerpt" id="excerpt" rows="2"
                        class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3" placeholder="Deskripsi singkat mengenai berita ini..."></textarea>
            ...
            <div class="w-full lg:w-80 space-y-6">
                ...
                <!-- Thumbnail Image -->
                <div class="bg-gray-50 border border-gray-200 rounded-xl p-5" x-data="imagePreview()">
                    <h3 class="text-sm font-bold text-gray-900 mb-4 border-b border-gray-200 pb-2">Gambar Utama (Thumbnail)</h3>
                    
                    <div class="mt-2 text-center">
                        <div x-show="!imageUrl" class="flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg bg-white relative hover:bg-gray-50 transition cursor-pointer" @click="$refs.fileInput.click()">
                        ...
                        <!-- Preview Area -->
                        <div x-show="imageUrl" class="relative rounded-lg overflow-hidden border border-gray-200 shadow-sm" style="display: none;">
...
<script>
    document.addEventListener('trix-file-accept', function(e) {
        e.preventDefault(); // Prevent file drops in Trix
    });
